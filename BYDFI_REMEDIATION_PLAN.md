...
**意义**：对 Google 来说，BYDFi 整个站缺 E-E-A-T 信号 = YMYL 金融内容**永远不可能进 SERP 前 10**。
...
每个内容页 `<head>` 加 JSON-LD（一次性 BYDFi engineering 工作）：
...
```json
{
  ...
  "author": {
    "@type": "Person",
    "name": "BYDFi Research Team",
    "url": "https://bydfi.com/author/research-team"
  },
  "reviewedBy": {
    "@type": "Person",
    "name": "BYDFi Risk Management Team",
    "url": "https://bydfi.com/author/risk-team"
  },
...
<footer class="article-meta">
  <p class="byline">
    Author: <a href="/author/research-team" rel="author">BYDFi Research Team</a>
    | Reviewed by: <a href="/author/risk-team">BYDFi Risk Management Team</a>
  ...
  <p>
    ...
    <a href="https://bydfi.com/futures-rules">BYDFi Futures Rules</a>
  </p>
</footer>
```
...
做多/做空公式不同，BYDFi BTC 维护保证金率 0.5%。
最后更新: 2026-06-08 | 来源: BYDFi Futures Rules
```
...
```
# BYDFi llms.txt
> BYDFi is a crypto futures exchange.

## Key resources
- [Futures Rules](https://bydfi.com/futures-rules)
- [Liquidation Calculator](https://bydfi.com/tools/liquidation)
- [Learn Center](https://bydfi.com/learn)
```
...
<a href="/futures/sol">Trade SOL futures on BYDFi</a>
```
...
# 3. 生成 HTML 报告分享给 CTO
uv run python scripts/render_report.py https://bydfi.com
...
2. 提供 BYDFi 内部 author profile 页面规范
...
*本方案基于 BYDFi SEO Audit Skill V1+V2 真实跑出的数据生成。*
